...
const Analytics = () => {
    ...
    const loadData = async () => {
        try {
            const [txnData, predData] = await Promise.all([
                api.getTransactions(),
                api.getPrediction().catch(() => null) // Fallback if no data
            ]);
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
                        ...
                        <div className="glass-panel p-6 lg:col-span-2 relative overflow-hidden">
                            ...
                            <p className="text-sm text-slate-400 mb-6">
                                Based on your {predictionData?.method === 'Mock Hybrid LSTM' ? 'historical spending patterns' : 'data'}, our AI predicts your future expenses.
                            </p>
